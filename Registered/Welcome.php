...
mysqli_query($cnn,"UPDATE tblclient SET Stat='1' WHERE ClientID='$ClientID'");
...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include '../Administrator/includes/Register/Welcome.html'
        ?>
    </ul> 
    </nav>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>WELCOME</b></font></center><br><br>
        <center><table width=95% border=1>
                <tr>
                    <td width=80%><font size=4>HI <?php echo strtoupper($ClientName)?></font>,</td>
                </tr>
                <tr height=30px></tr>
                <tr>
                    <td width=80%><font size=4>WELCOME TO DECENT TOUCH MASSAGE CENTER. THANK YOU FOR CONFIRMINNG YOUR EMAIL. PLEASE FEEL FREE TO MAKE RESERVATION ONLINE AND EXPERIENCE OUR BEST NATURAL MUSCLE RELAXING MASSAGE.</font></td>
                </tr>
                <tr height=30px></tr>
                <tr>
                    <td width=80%><font size=4>Best Regards,</font></td>
                </tr>
                 <tr>
                    <td width=80%><font size=4>Decent Touch Massage Center</font></td>
                </tr>
            </table></center>
    </div>
    </div>
